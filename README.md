...
- Non-interactive coloured POI dots on the elevation profile
...
- Separate Track panels for day distance, day ascent, every forward-looking point of interest on the selected day and the total walk
...
- Any number of break days between stages, with every later date shifted automatically
